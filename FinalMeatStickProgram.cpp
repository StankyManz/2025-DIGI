...
//below is the start to the webpage stating that ist in html, and then further goes on to clasify fonts and background colours
            ...
            client.println("<h2> Degrees Celsius </h2>"); // Stating unit

            client.println("<h2 style=\"font-family: 'Great Vibes', cursive; font-size: 36px; color: #513ccc; font-style: italic;\">Troy's Meat Guide</h2>"); //this line is giving the heading "Connors Meat Guide" its font, italics and colour (Royal Blue)
